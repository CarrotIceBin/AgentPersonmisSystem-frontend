<template>
  <div class="transfer-report-container">
    <!-- 页面标题 -->
    <div class="page-header">
      <h2 class="page-title">调动员工报表</h2>
      <p class="page-subtitle">查看企业员工调动情况</p>
    </div>
      ...
      <el-form ref="selectForm" :model="selectForm" class="form-content">
        <el-row :gutter="20">
          ...
          <el-col :span="8" class="form-button-col">
            <el-form-item>
              <el-button type="primary" class="search-button" @click="selectTransferStaffReportByCon">
                查询
              </el-button>
            </el-form-item>
          </el-col>
