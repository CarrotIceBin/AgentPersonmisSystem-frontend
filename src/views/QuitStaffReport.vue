  ...
  <div class="quit-staff-report-container">
      ...
      <el-form ref="selectForm" :model="selectForm" class="form-content">
        <el-row :gutter="20">
          ...
          <el-col :span="8" class="form-button-col">
            <el-form-item>
              <el-button type="primary" class="search-button" @click="selectQuitStaffReportByCon">
                查询
              </el-button>
            </el-form-item>
          </el-col>
    ...
    <div class="table-container">
      <el-table
        ...
        <el-table-column prop="qdate" label="离职日期" sortable width="160"></el-table-column>
