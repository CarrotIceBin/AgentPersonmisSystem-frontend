<template>
  <div class="staff-container">
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">管理企业员工信息</p>
    </div>
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="员工名称" prop="sname">
              <el-input v-model="selectForm.sname" placeholder="请输入员工名称" class="form-input"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  <el-dialog title="员工修改" v-model="staffDialogVisible"  width="100%">
   ...
   <el-row>
       ...
       <el-col :span="8">
            <el-form-item>
                <el-button type="primary" @click="update" :loading="loadingbut">{{loadingbuttext}}</el-button>
